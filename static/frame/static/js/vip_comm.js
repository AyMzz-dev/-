...
// 配置
layui.config({
    base: '../static/frame/static/js/'  // 模块目录
}).extend({                     // 模块别名
    vip_nav: 'vip_nav'
    , vip_tab: 'vip_tab'
    , vip_table: 'vip_table'
...
layui.use(['layer', 'element', 'util'], function () {
    ...
    function skin() {
        ...
        var html = $('html');
        html.removeClass('skin-0');
        html.removeClass('skin-1');
        html.removeClass('skin-2');
        html.removeClass('skin-3');
        html.addClass('skin-' + skin);
    }
    ...
    function _util() {
        ...
        if ($(window).width() < 1023) {
            util.fixbar({
                bar1: '&#xe602;'
                , css: {left: 10, bottom: 54, width: 50}
                , click: function (type) {
                    if (type === 'bar1') {
                        //iframe层
                        layer.open({
