...
<head>
    ...
    <title>查询授权 - <?php echo $G['config']['sitename'] ?></title>
...
<body class="login-page-bg">
    <div class="login-card animate-scaleIn">
        <div class="login-card-header">
            <h2><i class="fas fa-search"></i> 查询授权</h2>
            <p><?php echo $G['config']['sitename'] ?></p>
        </div>
        <div class="login-card-body">
            <div class="form-group">
                <i class="fab fa-qq"></i>
                <input class="form-control-custom" id="queryqq" type="text" placeholder="输入主人QQ或者机器人QQ或者代理QQ">
            </div>
